 ...
 */
final class Version20210127164332 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE referentiel ADD presentation VARCHAR(255) NOT NULL, ADD programme VARCHAR(255) NOT NULL, ADD critere_evaluation VARCHAR(255) NOT NULL, ADD critere_admission VARCHAR(255) NOT NULL');
    }
