...
class Competence
{
     ...
     * )
     * @Groups({"get_competences:read", "getById_competences:read", "getById_grpCompetences:read","get_competences_of_grpCompetence:read","getById_competences_of_grpCompetence:read","get_Referentiels:read","get_CompOfGrpCompByIdOfRefById:read"})
     */
    private $libelle;
